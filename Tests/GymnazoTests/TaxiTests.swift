...
struct TaxiTests {
    func makeTaxi(renderMode: RenderMode? = nil, isRainy: Bool? = nil, ficklePassenger: Bool? = nil)
        async throws -> Taxi
    {
    ...
    func testEncodeDecodeRoundtrip() async throws {
        for taxiRow in 0..<5 {
            for taxiCol in 0..<5 {
                for passLoc in 0..<5 {
                    for destIdx in 0..<4 {
                        let encoded = Taxi.encode(
                            taxiRow: taxiRow, taxiCol: taxiCol, passLoc: passLoc, destIdx: destIdx)
    ...
    func testPickupAtCorrectLocation() async throws {
        ...
        for seed: UInt64 in 0..<100 {
            ...
            let (taxiRow, taxiCol, passIdx, _) = Taxi.decode(
                try env.reset(seed: seed).obs.item(Int.self))
