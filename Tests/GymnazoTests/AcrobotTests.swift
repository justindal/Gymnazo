...
struct AcrobotTests {
    ...
    func testAcrobotSnapshotEquatable() async throws {
        let snapshot1 = AcrobotSnapshot(
            theta1: 0.1, theta2: 0.2, linkLength1: 1.0, linkLength2: 1.0)
        let snapshot2 = AcrobotSnapshot(
            theta1: 0.1, theta2: 0.2, linkLength1: 1.0, linkLength2: 1.0)
        let snapshot3 = AcrobotSnapshot(
            theta1: 0.3, theta2: 0.2, linkLength1: 1.0, linkLength2: 1.0)
