...
public final class EvalCallback<E: Env, P: Policy>: Callback
where E.Observation == MLXArray, E.Action == MLXArray {
    public let config: EvalCallbackConfig
    public let bestModelSavePath: URL?
    public var logger: (any Logger)?

    private var evalEnv: E
    ...
    /// Creates an evaluation callback for continuous action environments.
    ///
    /// - Parameters:
...
/// Evaluation callback for discrete action environments.
public final class DiscreteEvalCallback<E: Env, P: Policy>: Callback
where E.Observation == MLXArray, E.Action == Int {
    public let config: EvalCallbackConfig
    public let bestModelSavePath: URL?
    public var logger: (any Logger)?
    ...
    /// Creates an evaluation callback for discrete action environments.
    ///
    /// - Parameters:
    ///   - evalEnv: Environment for evaluation (separate from training).
    ///   - policy: The policy to evaluate.
